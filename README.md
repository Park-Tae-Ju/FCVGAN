...
### Train a New Model
`python train.py --dataroot ./datasets/house2zebra/ --name house2zebra_fcvgan --model fcvgan --dataset_mode unaligned --pool_size 50 --no_dropout --norm instance --lambda_identity 0.5 --load_size 286 --crop_size 256 --batch_size 4 --niter 100 --niter_decay 0 --gpu_ids 0 --display_id 0 --display_freq 100 --print_freq 100`
`python train.py --dataroot ./datasets/house2zebra/ --name house2zebra_fcvgan --model fcvgan --dataset_mode unaligned --pool_size 50 --no_dropout --norm instance --lambda_A 10 --lambda_B 10 --lambda_identity 0.5 --load_size 286 --crop_size 256 --batch_size 4 --niter 100 --niter_decay 0 --gpu_ids 0 --display_id 0 --display_freq 100 --print_freq 100 --epoch_count 1`
...
`python test.py --dataroot ./datasets/house2zebra/ --name house2zebra_attentiongan --model attention_gan --dataset_mode unaligned --norm instance --phase test --no_dropout --load_size 256 --crop_size 256 --batch_size 1 --gpu_ids 0 --num_test 5000 --epoch latest`
`python test.py --dataroot ./datasets/house2zebra/ --name house2zebra_fcvgan --model fcvgan --dataset_mode unaligned --norm instance --phase test --no_dropout --load_size 256 --crop_size 256 --batch_size 1 --gpu_ids 0 --num_test 5000 --epoch latest`
